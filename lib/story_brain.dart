...
class StoryBrain {
  ...
  // Return the story title from the storyData
  String getStory() => _storyData[_storyNum].storyTitle;

  String getChoice1() => _storyData[_storyNum].choice1;

  String getChoice2() => _storyData[_storyNum].choice2;
